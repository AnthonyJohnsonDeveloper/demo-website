...
const ReviewCard = (props) => {
  return (
    <div className="flex flex-col w-full lg:w-2/6 bg-white p-3 rounded-lg gap-5">
      ...
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel eum quas
        doloremque explicabo dolorem laboriosam obcaecati autem aspernatur
        commodi reiciendis, at dolore consectetur architecto quia!
      </p>
    </div>
  );
};
